  ...
  return (
    ...
    >
      <div className="relative  w-full h-full  aspect-video flex flex-row items-center justify-center">
        <img className="w-full h-full  object-center object-fill absolute drop-shadow-it4a-orange drop-shadow-2xl " src={img} alt={title} />
      </div>
    </figure>
  );
};

function SectionPartner({ t }: SectionPartnerProps) {
  return (
    ...
    <div className="relative flex w-full flex-col items-center backdrop-brightness-100 backdrop-blur-xs backdrop-opacity-95  justify-center py-10 px-4  overflow-hidden">
      <TitleDescript title={t.section_partner.title1} title2={t.section_partner.title2} descript={t.section_partner.description} className="text-center mb-10"/>

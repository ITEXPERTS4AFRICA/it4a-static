        ...
        >
            ...
            <div className="relative flex flex-col items-center">
                ...
                <div
                    style={{
                        ...
                        position:'relative',
                        height: 12,
                        borderLeft: "3px solid #f1ca13",
                        borderBottom: "3px solid #f1ca13",
            ...
            <div 
                style={{
                    width: "2px",
                    height: "40px",
                    background: "linear-gradient(to bottom, transparent, #f1ca13, transparent)",
